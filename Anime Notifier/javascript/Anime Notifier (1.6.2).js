...
// Visit: https://github.com/SkinnyDevi/scriptable/issues/new?assignees=&labels=bug&projects=&template=bug_report.md&title=Bug:+Issue+Name
// -------------User Config-------------
const NOTIFY_ME = [];
...
// ---------------Other Tools---------------
async function getWidget(simple, dim) {
...
function latestAnimeCheck(newAnimes) {
  ...
  const animeFromJSON = JSON.parse(loadedJSON);
  let notif = null;
